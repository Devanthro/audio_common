  ...
  class AudioPlayNode: public rclcpp::Node
  {
    public:
      ...
      : Node("audio_play_node", options)
      {
        ...
        _sub = this->create_subscription<std_msgs::msg::Int8MultiArray>(
    ...
    private:
      ...
      void onAudio(const std_msgs::msg::Int8MultiArray::SharedPtr msg) const
      {
     ...
     static void cb_newpad (GstElement *decodebin, GstPad *pad, 
      ...
      rclcpp::Subscription<std_msgs::msg::Int8MultiArray>::SharedPtr _sub;
